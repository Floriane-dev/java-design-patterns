...
public class DateUtils {
	...
	private static final DateTimeFormatter DEFAULT_FORMATTER_heure = DateTimeFormatter.ofPattern("dd/MM/yyyy HH:mm:ss");
...
/** Transforme une date au format String en {@link LocalDateTime}
	...
	public static LocalDateTime toDate(String dateStr) {
		...
		return LocalDateTime.parse(dateStr, DEFAULT_FORMATTER_heure);
